...
//    Update
    ...
    public  ResponseEntity<CategoryDto>updatedCategory(@PathVariable String categoryId,
...
//   Delete
    ...
    public ResponseEntity<ApiResponseMessage> deleteCategory(@PathVariable String categoryId){
        ...
        ApiResponseMessage responseMessage = ApiResponseMessage.builder().message("User is Deleted ").status(HttpStatus.OK).success(true).build();
...
//    get Single
    ...
    public  ResponseEntity<ProductDto>createProductWithCategory(@PathVariable ("categoryId") String categoryId,
        ...
        ProductDto productServiceWithCategory = productService.createWithCategory(dto, categoryId);
...
//    Update
    ...
    public  ResponseEntity<PageableResponse<ProductDto>>getProductOfCategory(
            @PathVariable String categoryId,@RequestParam (value = "pageNumber",defaultValue = "0",required = false)int pageNumber,
            @RequestParam( value = "pageSize", defaultValue = "10", required = false)int pageSize,
            @RequestParam(value = "sortBy",defaultValue = "title", required = false)String sortBy,
            @RequestParam(value = "sortDir",defaultValue = "asc",required = false)String sortDir){
